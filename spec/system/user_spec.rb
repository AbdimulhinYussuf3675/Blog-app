...
decribe 'User show page', type: :feature do
  before :each do
    @user1 = User.create(id: 1, name: 'user1', photo: 'photo.png', bio: 'this is my bio', posts_counter: 0)
    @post1 = @user1.posts.create(id: 1, title: 'post1', text: 'this is my text', comment_counter: 0, likes_counter: 0)
    @post2 = @user1.posts.create(id: 2, title: 'post2', text: 'this is my text', comment_counter: 0, likes_counter: 0)
    @post3 = @user1.posts.create(id: 3, title: 'post3', text: 'this is my text', comment_counter: 0, likes_counter: 0)
    @post4 = @user1.posts.create(id: 4, title: 'post4', text: 'this is my text', comment_counter: 0, likes_counter: 0)
    @comment1 = @post1.comments.create(id: 1, text: 'this is my text', author: @user1)

    visit user_path(@user1)
  end
  it 'I can see the user\'s first 3 posts.' do
    expect(page).to have_selector('.post-title', count: 3)
  end
